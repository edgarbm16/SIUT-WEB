...
ALTER TABLE `alumnosfaltas`
  ...
  ADD CONSTRAINT `fk_id_faltas` FOREIGN KEY (`IdFaltas`) REFERENCES `faltas` (`IdFaltas`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `asignatura`
  ...
  ADD CONSTRAINT `fk_id_global` FOREIGN KEY (`IdGlobal`) REFERENCES `global` (`IdGlobal`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `calificaciones`
  ...
  ADD CONSTRAINT `fk_id_promedio` FOREIGN KEY (`IdPromedio`) REFERENCES `promedio` (`IdPromedio`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `cuatrimestre`
--
ALTER TABLE `cuatrimestre`
  ADD CONSTRAINT `fk_id_nivel` FOREIGN KEY (`IdNivel`) REFERENCES `nivel` (`IdNivel`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `cuatrimestrecarrera`
  ...
  ADD CONSTRAINT `fk_id_cuatrimestrec` FOREIGN KEY (`IdCuatrimestre`) REFERENCES `cuatrimestre` (`IdCuatrimestre`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `curso`
  ...
  ADD CONSTRAINT `fk_id_profesores` FOREIGN KEY (`IdProfesores`) REFERENCES `profesores` (`IdProfesores`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `cursosgrupos`
  ...
  ADD CONSTRAINT `fk_id_grupo` FOREIGN KEY (`IdGrupo`) REFERENCES `grupo` (`IdGrupo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `documentosa`
--
ALTER TABLE `documentosa`
  ADD CONSTRAINT `fk_id_alumnosd` FOREIGN KEY (`IdAlumnos`) REFERENCES `alumnos` (`IdAlumnos`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `documentosp`
--
ALTER TABLE `documentosp`
  ADD CONSTRAINT `fk_id_profesoresd` FOREIGN KEY (`IdProfesores`) REFERENCES `profesores` (`IdProfesores`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `inscripcionalumnos`
  ...
  ADD CONSTRAINT `fk_id_inscripcion` FOREIGN KEY (`IdInscripcion`) REFERENCES `inscripcion` (`IdInscripcion`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `pagosalumnos`
  ...
  ADD CONSTRAINT `fk_id_pagos` FOREIGN KEY (`IdPagos`) REFERENCES `pagos` (`IdPagos`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `profesores`
--
ALTER TABLE `profesores`
  ADD CONSTRAINT `fk_id_usuariosp` FOREIGN KEY (`IdUsuarios`) REFERENCES `usuarios` (`IdUsuarios`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;

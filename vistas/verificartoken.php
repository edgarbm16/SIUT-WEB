...
<body>
    <div class="container">
        <div class="row justify-content-md-center" style="margin-top:15%">
            <?php if($correcto){ ?>
                <form class="col-4" action="../controlador/cambiarpassword.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-success"  style="background-color: #00a886">Cambiar</button>
                </form>
            <?php }else{ ?>

      ...
      <article class="col-lg-3 col-sm-6 mb-5">
        <div class="card rounded-0 border-bottom border-primary border-top-0 border-left-0 border-right-0 hover-shadow">
          ...
          <div class="card-body">
            ...
            <a href="blog-single.html" class="btn btn-primary" data-toggle="modal" data-target="#signupModalAlumn">Registrar Alumno</a>
          </div>
        </div>
      </article>
      <!-- blog post -->
      <article class="col-lg-3 col-sm-6 mb-5">
        <div class="card rounded-0 border-bottom border-primary border-top-0 border-left-0 border-right-0 hover-shadow">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicin</p> -->
            <a href="blog-single.html" class="btn btn-primary" data-toggle="modal" data-target="#signupModalProf">Registrar Profesor</a>
          </div>
        </div>
      </article>
      <!-- blog post -->

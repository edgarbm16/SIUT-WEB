...
<body>
    <div class="container">
        <div class="row justify-content-md-center" style="margin-top:15%">
            <form class="col-4" action="../vistas/verificartoken.php" method="POST">
                <h2>Restablecer contraseña</h2>
                <div class="mb-3">
                    <p>Por favor ingresa el codigo que recibiste en tu correo electronico.</p>
                ...
                <button type="submit"  class="btn btn-success"  style="background-color: #00a886">Restablecer</button>
            </form>
        </div>
    </div>
